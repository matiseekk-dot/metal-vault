      ...
      <div style={{padding:'0 24px 40px'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
          <div style={{background:C.bg2,border:'1px solid '+C.border,borderRadius:12,padding:'18px 14px'}}>
            ...
            <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:32,color:C.gold,marginBottom:14,lineHeight:1}}>Free</div>
          ...
          <div style={{background:'linear-gradient(135deg,#1a0800,#2a1000)',border:'2px solid '+C.gold,borderRadius:12,padding:'18px 14px',position:'relative'}}>
            ...
            <div style={{fontFamily:"'Bebas Neue',sans-serif",fontSize:32,color:C.gold,marginBottom:14,lineHeight:1}}>${PRO_MONTHLY_USD} <span style={{fontSize:12,color:C.muted}}>/mo</span></div>
