        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
          {FEATURES.map((f,i)=>(
            <div key={i} style={{background:C.bg2,border:'1px solid '+C.border,borderRadius:10,padding:'14px 12px'}}>
              ...
              <div style={{fontFamily:"var(--font-bebas-neue), sans-serif",fontSize:16,letterSpacing:'0.04em',marginBottom:4,lineHeight:1}}>{f.title}</div>
      ...
      <div style={{padding:'0 24px 40px'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
          <div style={{background:C.bg2,border:'1px solid '+C.border,borderRadius:12,padding:'18px 14px'}}>
            <div style={{fontFamily:"var(--font-bebas-neue), sans-serif",fontSize:20,marginBottom:4}}>FREE</div>
            <div style={{fontFamily:"var(--font-bebas-neue), sans-serif",fontSize:32,color:C.gold,marginBottom:14,lineHeight:1}}>Free</div>
          ...
          <div style={{background:'linear-gradient(135deg,#1a0800,#2a1000)',border:'2px solid '+C.gold,borderRadius:12,padding:'18px 14px',position:'relative'}}>
            ...
            <div style={{fontFamily:"var(--font-bebas-neue), sans-serif",fontSize:20,marginBottom:4}}>PRO</div>
            <div style={{fontFamily:"var(--font-bebas-neue), sans-serif",fontSize:32,color:C.gold,marginBottom:14,lineHeight:1}}>${PRO_MONTHLY_USD} <span style={{fontSize:12,color:C.muted}}>/mo</span></div>
            <div style={{fontSize:10,color:C.muted,marginBottom:10}}>or ${PRO_YEARLY_USD}/year (save {YEARLY_SAVINGS_PCT}%)</div>
