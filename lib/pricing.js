...
// ── Backward-compat aliases for code that still uses the old PLN names ──
// TODO: remove these after sweeping for usages. Kept temporarily so we don't
// have to touch every importing file in one PR.
export const PRO_MONTHLY_PLN    = PRO_MONTHLY_USD;
export const PRO_YEARLY_PLN     = PRO_YEARLY_USD;
export const PRO_MONTHLY_GROSZE = PRO_MONTHLY_CENTS;
export const PRO_YEARLY_GROSZE  = PRO_YEARLY_CENTS;
