...
export const FREE_LIMIT_RECORDS  = 50;   // max collection items on free tier
export const PRICE_MONTHLY_PLN   = 999;  // 9.99 PLN in grosze
export const PRICE_YEARLY_PLN    = 7999; // 79.99 PLN in grosze
